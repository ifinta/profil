...
impl UiI18n for GermanUi {
    ...
    fn item_label(&self, key: &str) -> &'static str {
        match key {
            ...
            "cert_presentation" => "Präsentationstechniken",
            "cert_access" => "MS Access 2003 (Mittelstufe)",
            "cert_canoe" => "CANoe Grundlagen",
            "cert_dotnet" => ".NET, C# Kurs",
            "cert_moderation" => "Moderation – Grundlagen",
    ...
    fn item_hint(&self, key: &str) -> &'static str {
        match key {
            ...
            "cert_scrum" => "Scrum — PORSCHE-interner Kurs",
            "cert_istqb" => "ISTQB-Seminar — Bosch-interner Kurs",
            "cert_presentation" => "Präsentationstechniken — Develor Kurs",
            "cert_access" => "MS Access 2003 (Mittelstufe) — Controll Training",
            "cert_canoe" => "CANoe Grundlagen — VECTOR",
            "cert_dotnet" => ".NET, C# Kurs — BME",
            "cert_moderation" => "Moderation – Grundlagen — Bosch-intern",
            "cert_daf" => "Deutsch als Fremdsprache — Friedrich Schiller Universität Jena (TEMPUS-Stipendium)",
            "cert_germanistik" => "Internat. Sommersemester für Germanistik — FSU Jena (Internationales Sommer-Sprachcamp)",
            // Workplace hints
